          ...
          {activeTab === "pencairan" && (
            <div className="card" style={{ padding: 40 }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }}>
                  <div><label style={{ display: "block", fontWeight: 500, marginBottom: 8 }}>Jenis Pinjaman *</label><select value={formData.sistem} onChange={handleSistemChange} style={{ width: "100%", padding: "14px 16px", borderRadius: 8, border: "2px solid #eee", fontSize: 16, background: "white" }}><option value="flat">Flat</option><option value="musiman">Musiman</option></select></div>
